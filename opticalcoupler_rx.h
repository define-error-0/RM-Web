#ifndef OPTICALCOUPLER_RX_H
#define OPTICALCOUPLER_RX_H
...
public:
    OpticalcouplerRx(char cmd, short Gpio);
    ~OpticalcouplerRx();
    ...
    // EXTI中断处理函数（需要在外部EXTI中断中调用）
    void extiInterruptHandler();
